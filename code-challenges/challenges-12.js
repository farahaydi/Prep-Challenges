...
const cvsFiltration = (arr) => {
    // write your code here
    const filterArr = arr.filter(ele => ele.yearsOfExperience > 4 && ele.tech == 'JS');

    const result = filterArr.map(ele => ({
...
const vowelsFiltration = (arr) => {
    ...
    const result = arr.filter(ele => !vowels.some(vowel => ele.includes(vowel)));
    return result;
};
// -------------------------------------------------------------------------------------------------------
