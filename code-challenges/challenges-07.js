...
const cvFormatter = (arr) => {
    ...
    for (let index = 0; index < arr.length; index++) {
      const applicant = arr[index];
      const firstName = applicant.firstName;
      const lastName = applicant.lastName;
      const yearsOfExperience = applicant.yearsOfExperience;
      const tech = applicant.tech;
  
      if (yearsOfExperience > 1 && firstName !== null && lastName !== null) {
        const fullName = firstName + " " + lastName;
        delete applicant.yearsOfExperience;
        reformattedCvs.push({ fullName, tech });
      } else if (yearsOfExperience > 1 && firstName === null && lastName !== null) {
